...
<div class="wrap pld-wrap">
    <div class="pld-header" style="background: black!important;"><h3><?php _e('Posts Like Dislike for 5play themes', 'posts-like-dislike'); ?><span class="pld-avatar-holder"><img src="<?php echo PLD_IMG_DIR . '/avatar.jpeg'; ?>"/></span></h3></div>
