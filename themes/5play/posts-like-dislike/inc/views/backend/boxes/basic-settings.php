<div class="pld-settings-section" data-settings-ref="basic">
    <div class="pld-field-wrap" >
        <label><?php _e('Enable', PLD_TD); ?></label>
        <div class="pld-field">
            ...
            <p class="description"><?php _e('Please enable to showing posts like and dislike ', PLD_TD); ?></p>
        </div>
    </div>
    <div class="pld-field-wrap" style="display:none">
