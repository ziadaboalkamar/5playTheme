...
if (!class_exists('PLD_Admin')) {
    ...
    class PLD_Admin extends PLD_Library {
        ...
        function pld_admin_menu() {
            add_menu_page(__('Posts Like Dislike', 'posts-like-dislike'), __('Posts Like Dislike', 'posts-like-dislike'), 'manage_options', 'posts-like-dislike', array($this, 'pld_settings'), 'dashicons-thumbs-up');
        }
