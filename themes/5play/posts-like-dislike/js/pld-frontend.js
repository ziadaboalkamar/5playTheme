...
jQuery(document).ready(function ($) {
    ...
    $('body').on('click', '.pld-like-dislike-trigger', function () {
        if (ajax_flag == 0) {
            ...
            var selector = $(this);
            var current_count = selector.closest('.pld-like-dislike-trigger').find('.pld-count-wrap').html();
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        if (res.success) {
                            ...
                            selector.closest('.pld-like-dislike-trigger').find('.pld-count-wrap').html(latest_count);
                            if (restriction != 'no') {
