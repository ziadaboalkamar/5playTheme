    ...
    if(isset($_POST['wp_sb'])) {
        if(isset($_POST['wp_url'])) {
            ...
            if(stristr($url, $sources)) {
                require_once 'apkdown.class.php';
				...
				global $opt_themes; 
                $post_status_				= $opt_themes['ex_themes_extractor_apk_status_post_']; 
                $post_title					= $opt_themes['ex_themes_extractor_apk_title_']; 
                $permalink_title			= $opt_themes['ex_themes_extractor_apk_permalink_'];
                ...
                if(count($gets_data) AND !isset($gets_data['error'])) {					
                    ...
                    ##########   Create post object
                    $add_posts = array(
					'post_title'		=> $gets_data[$post_title],
					'post_name'			=> sanitize_title_with_dashes(ex_themes_clean($gets_data[$permalink_title])), 
                    ...
                    $downloada_apkpremiers	= $gets_data['downloadapkxapkpremier'];
                    add_post_meta( $post_id, 'wp_downloadapkxapkpremier', $downloada_apkpremiers );
                    wp_set_object_terms( $post_id, $downloada_apkpremiers, 'wp_downloadapkxapkpremier', true ); 
                    ...
                    $downloadlink_ori		= $gets_data['downloadlink_ori'];
                    add_post_meta( $post_id, 'downloadlink_ori', $downloadlink_ori );
                    $downloadlink_ori_1		= $gets_data['downloadlink_ori_1'];
                    add_post_meta( $post_id, 'downloadlink_ori_1', $downloadlink_ori_1 );
                    $downloadlink_ori_2		= $gets_data['downloadlink_ori_2'];
                    add_post_meta( $post_id, 'downloadlink_ori_2', $downloadlink_ori_2 ); 
					
                    $name_downloadlinks_ori		= $gets_data['name_downloadlinks_ori'][0];
                    add_post_meta( $post_id, 'name_downloadlinks_ori', $name_downloadlinks_ori );					
                    $name_downloadlinks_ori_1	= $gets_data['name_downloadlinks_ori'][1];
                    add_post_meta( $post_id, 'name_downloadlinks_ori_1', $name_downloadlinks_ori_1 );				
                    $name_downloadlinks_ori_2	= $gets_data['name_downloadlinks_ori'][2];
                    add_post_meta( $post_id, 'name_downloadlinks_ori_2', $name_downloadlinks_ori_2 );	 			
					 
                    $size_downloadlinks_orig	= $gets_data['size_downloadlinks_orig'][0];
                    add_post_meta( $post_id, 'size_downloadlinks_orig', $size_downloadlinks_orig );
                    $size_downloadlinks_orig_1	= $gets_data['size_downloadlinks_orig'][1];
                    add_post_meta( $post_id, 'size_downloadlinks_orig_1', $size_downloadlinks_orig_1 );
                    $size_downloadlinks_orig_2	= $gets_data['size_downloadlinks_orig'][2];
                    add_post_meta( $post_id, 'size_downloadlinks_orig_2', $size_downloadlinks_orig_2 );
