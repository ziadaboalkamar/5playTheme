...
function wp_farsroid() {
$types			= 'post';
$sources		= 'www.farsroid.com';
$demos			= 'https://www.farsroid.com/idle-miner-tycoon/'; 
?>
    ...
    if(isset($_POST['wp_sb'])) {
        ...
        if(isset($_POST['wp_url'])) {
            ...
            if(stristr($url, $sources)) {
                require_once 'farsroid.class.php';
				########## 
				global $opt_themes;
    ...
    <div class="wrap">
        <div class="play_fixedx play_menu" id="play_fixed" style="margin-bottom: 10px;">
            ...
            <ul class="play_menus" style="text-transform:capitalize">
                ...
                <li><a data-toggle="tab" href="#menu1"><i class="fa fa-rss"></i> Latest Updates</a></li> 
