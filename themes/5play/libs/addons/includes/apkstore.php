        ...
        <div class="tab-content">
			...
			<div id="menu5" class="tab-pane fade">
               ...
               <?php ini_set('display_errors', 'off');
					...
					$contents =  preg_replace('#<a href="(.*?)" class="short_block_link">.*?<img src="(.*?)".*?class="short_block_link_image">.*?<div class="short_block_link_title">(.*?)</div>.*?</a>#si', '<li class="table-row"> 
						<div class="col col-1" data-label="Image"><img style="width:50px; height:50px;" src="$2"></div>
						<div class="col col-2" data-label="Title"><h3 style="font-size: 1.7rem;">$3</h3></div>
						<div class="col col-3" data-label="Submit"><form name="myForm" id="myForm" method="POST" class="sidebar" style=""><input style="display:none" type="text" name="wp_url" value="$1"><input type="submit" id="submit" name="wp_sb" class="button-primary abe2" value="'.postnow2.'"></form></div>
					</li> ', $contents);
