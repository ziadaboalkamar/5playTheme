    ...
    <section class="wrp section section-recom">
        <h3 class="section-title"><i class="s-green c-icon"><svg width="24" height="24"><use xlink:href="#i__hot"></use></svg></i><?php global $opt_themes; if($opt_themes['exthemes_Recommend']) { ?><?php echo $opt_themes['exthemes_Recommend']; ?><?php } ?></h3>
        <div class="scroll-entry-list">
			...
			<?php 
					...
					if ( $thumbnails === FALSE or $thumbnails == '' ) $thumbnails = $image_url_default;
                                    ...
                                    <span class="recom-post-vers"><svg width="24" height="24"><use xlink:href="#i__android"></use></svg><?php global $opt_themes; if($opt_themes['ex_themes_rtl_activate_']) { ?>
