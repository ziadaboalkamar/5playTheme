	...
	<div class="sel-lang">
        ...
        if( !empty( $languages ) ){?>
            ...
            foreach( $languages as $l ){
                ...
                <button class="sel-lang__en <?php if ($l['active']) echo 'active';?>" ><i class="lang_icon"><img src="<?php echo $l['country_flag_url']; ?>" alt="Английский" title="Английский" width="24" height="24"></i></button>
