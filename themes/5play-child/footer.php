...
<!--        --><?php //if (!function_exists('dynamic_sidebar') || !dynamic_sidebar('home-footers')): endif; ?>
...
<!---->
<!--                        <p class="copyright">-->
<!--                            <a href='https://demo-5play.test'>5play Themes Premium</a> - © <script type='text/javascript'>var creditsyear = new Date();document.write(creditsyear.getFullYear());</script> --><?php //echo esc_html__("All rights reserved - Developer by",CHILD_THEME) ?><!-- <a href='https://exthem.es' title='premium wordpress themes - Exthemes Devs'><strong style='text-transform: capitalize;'>Exthemes Devs</strong></a>-->
...
<!--                            <h2 class="footer-heading">--><?php //echo esc_html__('Find Us', CHILD_THEME); ?><!--</h2>-->
                                    ...
                                    <?php if ( is_active_sidebar( 'footer-widget-area-3' ) ) : ?>
                                        <li>
                                            <a href="#">
                                                ...
                                                <span class="text"><?php dynamic_sidebar( 'footer-widget-area-3' ); ?></span>
                                            </a>
                                        </li>
                                    <?php endif; ?>
    ...
    <?php if ( is_active_sidebar( 'footer-widget-area-4' ) ) : ?>
                                            <p c`lass="copyright">
                                                <a href='https://demo-5play.test'>App store</a> - © <script type='text/javascript'>var creditsyear = new Date();document.write(creditsyear.getFullYear());</script> <?php echo esc_html__("© Copyright AppsStore.com ",CHILD_THEME) ?> <a href='https://exthem.es' title='premium wordpress themes - Exthemes Devs'><strong style='text-transform: capitalize;'>Digital Trends</strong></a> <span class="text"><?php dynamic_sidebar( 'footer-widget-area-4' ); ?></span>
                    <?php //ex_themes_copyright_(); ?>
    ...
    <?php endif; ?>
        ...
        <style>
            ...
            .footer-01 ul.list-unstyled li:not(:last-child) a:after {
                content: "|";
                margin-left: 10px;
                color: #0071f3;
                font-size: 14px;
...
?>
    ...
    <footer class="footer-01">
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-lg-3 mb_dt mb-md-0">
                    <h3 class="footer-heading"><?php echo get_option('blogname'); ?></h3>
                    <p>  <?php if ( is_active_sidebar( 'footer-widget-area-1' ) ) : ?>
                            <?php dynamic_sidebar( 'footer-widget-area-1' ); ?>
                        <?php endif; ?></p>
                </div>
                <div class="col-md-6 col-lg-3 mb_dt mb-md-0">
                    <h3 class="footer-heading"><?php echo esc_html__('Latest News', CHILD_THEME); ?></h3>
                    <?php get_last_news(); ?>
                </div>
                <div class="col-md-6 col-lg-3 pl-lg-5 mb_dt mb-md-0">
                    <h3 class="footer-heading"><?php echo esc_html__('Quick Links', CHILD_THEME); ?></h3>
                    <ul class="list-unstyled">
                        <?php if ( is_active_sidebar( 'footer-widget-area-2' ) ) : ?>
                            <?php dynamic_sidebar( 'footer-widget-area-2' ); ?>
                        <?php endif; ?>
                ...
                <div class="col-md-6 col-lg-3 mb_dt mb-md-0">
                    <h3 class="footer-heading"><?php echo esc_html__('Find Us', CHILD_THEME); ?></h3>
                    <div class="block-23 mb-3">
                        <ul>
                            <?php if ( is_active_sidebar( 'footer-widget-area-3' ) ) : ?>
