...
class widget_footer
{
    public function __construct() {
        $widget_ops = array(
            'classname'   => 'footer-home-widgets',
            'description' => __( EX_THEMES_NAMES_.' Add footer in theme', THEMES_NAMES  ),
        );
        parent::__construct( 'footer-home-widgets', __( '(5Play) Footer Widget', THEMES_NAMES  ), $widget_ops );
    }
    ...
    public function form( $instance ) {
        ...
        $page_ids		= array_map( 'absint', $instance['page_ids'] );
        ...
        $number_of_cats = count( $page );
        $number_of_rows = ( 10 > $number_of_cats ) ? $number_of_cats + 1 : 10;
        if ( in_array( 0, $page_ids, true ) ) {
            $page_ids = array( 0 );
        }
        ...
        if ( 0 < $number_of_cats ) {
            ...
            while ( $page ) {
                ...
                if ( 0 === $page[0]->parent ) {
                    ...
                    $current_entry = array_shift( $page );
                ...
                $parent_index = $this->get_cat_parent_index( $cat_list, $page[0]->parent );
